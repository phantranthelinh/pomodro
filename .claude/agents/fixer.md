...
> See `.claude/skills/references/fix-patterns.md` for common patterns: interface→type, 'use client', route exports, hardcoded colors, business logic in components, placeholder functions.
